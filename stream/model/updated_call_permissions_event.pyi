...
class UpdatedCallPermissionsEvent(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["call_cid", "created_at", "own_capabilities", "type", "user", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["call_cid", "created_at", "own_capabilities", "type", "user", ], str]):
