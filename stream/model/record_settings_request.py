...
class RecordSettingsRequest(
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["audio_only"]) -> typing.Union[MetaOapg.properties.audio_only, schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        audio_only: typing.Union[MetaOapg.properties.audio_only, bool, schemas.Unset] = schemas.unset,
