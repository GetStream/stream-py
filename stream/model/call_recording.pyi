...
class CallRecording(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["end_time", "filename", "start_time", "url", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["end_time", "filename", "start_time", "url", ], str]):
