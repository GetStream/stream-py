...
class CallRequest(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class members(
                ...
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['MemberRequest'], typing.List['MemberRequest']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'members':
                    return super().__new__(
                        cls,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["created_by"]) -> 'UserRequest': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["created_by_id"]) -> MetaOapg.properties.created_by_id: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["settings_override"]) -> 'CallSettingsRequest': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["created_by", "created_by_id", "custom", "members", "settings_override", "starts_at", "team", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["created_by"]) -> typing.Union['UserRequest', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["created_by_id"]) -> typing.Union[MetaOapg.properties.created_by_id, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["settings_override"]) -> typing.Union['CallSettingsRequest', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["created_by", "created_by_id", "custom", "members", "settings_override", "starts_at", "team", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        created_by_id: typing.Union[MetaOapg.properties.created_by_id, str, schemas.Unset] = schemas.unset,
        ...
        settings_override: typing.Union['CallSettingsRequest', schemas.Unset] = schemas.unset,
