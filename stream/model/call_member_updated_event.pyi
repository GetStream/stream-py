...
class CallMemberUpdatedEvent(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["call", "call_cid", "created_at", "members", "type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["call", "call_cid", "created_at", "members", "type", ], str]):
