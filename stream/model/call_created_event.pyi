...
field is set to true and if so, show the call screen
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ringing"]) -> MetaOapg.properties.ringing: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["call", "call_cid", "created_at", "members", "ringing", "type", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ringing"]) -> MetaOapg.properties.ringing: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["call", "call_cid", "created_at", "members", "ringing", "type", ], str]):
