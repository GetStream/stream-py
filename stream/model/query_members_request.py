...
class QueryMembersRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["filter_conditions", "type", "id", "limit", "next", "prev", "sort", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["filter_conditions"]) -> MetaOapg.properties.filter_conditions: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["filter_conditions", "type", "id", "limit", "next", "prev", "sort", ], str]):
        return super().get_item_oapg(name)
