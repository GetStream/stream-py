...
class CustomVideoEvent(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["call_cid", "created_at", "custom", "type", "user", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["call_cid", "created_at", "custom", "type", "user", ], str]):
        return super().get_item_oapg(name)
