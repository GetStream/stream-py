...
class EdgeResponse(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["latency_test_url"]) -> MetaOapg.properties.latency_test_url: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["subdivision_iso_code"]) -> MetaOapg.properties.subdivision_iso_code: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["yellow"]) -> MetaOapg.properties.yellow: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["continent_code", "country_iso_code", "green", "id", "latency_test_url", "latitude", "longitude", "red", "subdivision_iso_code", "yellow", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["continent_code"]) -> MetaOapg.properties.continent_code: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["country_iso_code"]) -> MetaOapg.properties.country_iso_code: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["green"]) -> MetaOapg.properties.green: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["id"]) -> MetaOapg.properties.id: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["latency_test_url"]) -> MetaOapg.properties.latency_test_url: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["red"]) -> MetaOapg.properties.red: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["subdivision_iso_code"]) -> MetaOapg.properties.subdivision_iso_code: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["yellow"]) -> MetaOapg.properties.yellow: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["continent_code", "country_iso_code", "green", "id", "latency_test_url", "latitude", "longitude", "red", "subdivision_iso_code", "yellow", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        red: typing.Union[MetaOapg.properties.red, decimal.Decimal, int, ],
        country_iso_code: typing.Union[MetaOapg.properties.country_iso_code, str, ],
        green: typing.Union[MetaOapg.properties.green, decimal.Decimal, int, ],
        latitude: typing.Union[MetaOapg.properties.latitude, decimal.Decimal, int, float, ],
        yellow: typing.Union[MetaOapg.properties.yellow, decimal.Decimal, int, ],
        continent_code: typing.Union[MetaOapg.properties.continent_code, str, ],
        latency_test_url: typing.Union[MetaOapg.properties.latency_test_url, str, ],
        id: typing.Union[MetaOapg.properties.id, str, ],
        subdivision_iso_code: typing.Union[MetaOapg.properties.subdivision_iso_code, str, ],
