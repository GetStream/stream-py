...
class GetCallResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["blocked_users", "call", "duration", "members", "membership", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["blocked_users", "call", "duration", "members", "membership", ], str]):
