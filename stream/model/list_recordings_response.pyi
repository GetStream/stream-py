...
class ListRecordingsResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class recordings(
                ...
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['CallRecording'], typing.List['CallRecording']],
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["duration", "recordings", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["duration", "recordings", ], str]):
...
from openapi_client.model.call_recording import CallRecording
