...
class UserResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["created_at", "custom", "id", "role", "updated_at", "deleted_at", "image", "name", "teams", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["created_at", "custom", "id", "role", "updated_at", "deleted_at", "image", "name", "teams", ], str]):
        return super().get_item_oapg(name)
