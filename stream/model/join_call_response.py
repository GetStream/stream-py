...
class JoinCallResponse(
        ...
        class properties:
            ...
            class edges(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['DatacenterResponse']:
                        return DatacenterResponse
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['DatacenterResponse'], typing.List['DatacenterResponse']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'edges':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'DatacenterResponse':
                    return super().__getitem__(i)
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["blocked_users"]) -> MetaOapg.properties.blocked_users: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["membership"]) -> 'MemberResponse': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["blocked_users", "call", "created", "duration", "edges", "members", "membership", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["blocked_users"]) -> MetaOapg.properties.blocked_users: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["membership"]) -> typing.Union['MemberResponse', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["blocked_users", "call", "created", "duration", "edges", "members", "membership", ], str]):
...
from openapi_client.model.datacenter_response import DatacenterResponse
