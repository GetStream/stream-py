...
class GetOrCreateCallRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["data", "members_limit", "ring", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["data", "members_limit", "ring", ], str]):
