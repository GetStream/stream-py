...
class SendReactionResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["duration", "reaction", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["duration", "reaction", ], str]):
