...
class GetEdgesResponse(
        ...
        class properties:
            ...
            class edges(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['EdgeResponse']:
                        return EdgeResponse
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['EdgeResponse'], typing.List['EdgeResponse']],
                ...
                def __getitem__(self, i: int) -> 'EdgeResponse':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["duration", "edges", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["duration", "edges", ], str]):
