...
If the user is the current user, the client should leave the call screen as well
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["blocked_by_user"]) -> 'UserResponse': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["call_cid", "created_at", "type", "user", "blocked_by_user", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["blocked_by_user"]) -> typing.Union['UserResponse', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["call_cid", "created_at", "type", "user", "blocked_by_user", ], str]):
