...
class SortParamRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["direction", "field", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["direction", "field", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, None, ],
        direction: typing.Union[MetaOapg.properties.direction, decimal.Decimal, int, schemas.Unset] = schemas.unset,
