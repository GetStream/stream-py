...
class HealthCheckEvent(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["connection_id", "created_at", "type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["connection_id", "created_at", "type", ], str]):
