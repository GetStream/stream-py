...
class CallReactionEvent(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["reaction"]) -> 'ReactionResponse': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["call_cid", "created_at", "reaction", "type", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["reaction"]) -> 'ReactionResponse': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["call_cid", "created_at", "reaction", "type", ], str]):
