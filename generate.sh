...
( cd $SOURCE_PATH ; make openapi ; make -C tools/openapi build ; ./build/openapi generate-client --language python --spec ./releases/v2/serverside-api.yaml --output ../stream-py/getstream/ )

# Regenerate webhook conformance fixtures (CHA-2961)
( cd $SOURCE_PATH ; ./build/openapi generate-webhook-fixtures --output ../stream-py/tests/assets/webhooks --time-format=unix-ns )
