...
Entries from 6.1.1 on are generated by release-please from commit messages; earlier
ones were written by hand in the [Keep a Changelog](https://keepachangelog.com/en/1.0.0/)
format.

## [6.1.1](https://github.com/GetStream/stream-py/compare/v6.1.0...v6.1.1) (2026-09-24)


### Bug Fixes

* **ci:** find the pending release by label instead of by page ([#288](https://github.com/GetStream/stream-py/issues/288)) ([43551f5](https://github.com/GetStream/stream-py/commit/43551f522cd83a262a13a0664ede204d2d96d1b9))
* **ci:** treat an unknown release state as pending, not as none ([#290](https://github.com/GetStream/stream-py/issues/290)) ([062afd7](https://github.com/GetStream/stream-py/commit/062afd75d0e1b9b0ecc8f9a7ec4e40e356e7c1b6))
...
- Scoped the `F401`/`UP035` lint suppressions to the generated models module.

## [5.1.0] - 2026-08-25

### Changed

- Regenerated the OpenAPI client (CHA-4947).

## [5.0.0] - 2026-08-17

### Changed

- **Breaking:** regenerated from chat v235.17.1 (#281).

## [4.3.0] - 2026-08-12

### Fixed

- Name the HTTP status when the error body is not JSON (#280).
