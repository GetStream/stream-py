...
class CommonRestClient(BaseClient):
    ...
    def delete_device(self, id: Optional[str]=None, user_id: Optional[str]=None) -> StreamResponse[Response]:
        query_params = {
    ...
    def create_device(self, create_device_request: CreateDeviceRequest=None) -> StreamResponse[Response]:
        return self.post("/api/v2/devices", Response, json=request_to_dict(create_device_request))
    
    def export_users(self, export_users_request: ExportUsersRequest=None) -> StreamResponse[ExportUsersResponse]:
        return self.post("/api/v2/export/users", ExportUsersResponse, json=request_to_dict(export_users_request))
    
    def create_guest(self, create_guest_request: CreateGuestRequest=None) -> StreamResponse[CreateGuestResponse]:
    ...
    def create_import(self, create_import_request: CreateImportRequest=None) -> StreamResponse[CreateImportResponse]:
    ...
    def get_og(self, url: Optional[str]=None) -> StreamResponse[GetOGResponse]:
        query_params = {
    ...
    def create_role(self, create_role_request: CreateRoleRequest=None) -> StreamResponse[CreateRoleResponse]:
    ...
    def update_users_partial(self, update_users_partial_request: UpdateUsersPartialRequest=None) -> StreamResponse[UpdateUsersResponse]:
        return self.patch("/api/v2/users", UpdateUsersResponse, json=request_to_dict(update_users_partial_request))
    
    def update_users(self, update_users_request: UpdateUsersRequest=None) -> StreamResponse[UpdateUsersResponse]:
        return self.post("/api/v2/users", UpdateUsersResponse, json=request_to_dict(update_users_request))
    
    def deactivate_users(self, deactivate_users_request: DeactivateUsersRequest=None) -> StreamResponse[DeactivateUsersResponse]:
        return self.post("/api/v2/users/deactivate", DeactivateUsersResponse, json=request_to_dict(deactivate_users_request))
    
    def delete_users(self, delete_users_request: DeleteUsersRequest=None) -> StreamResponse[DeleteUsersResponse]:
        return self.post("/api/v2/users/delete", DeleteUsersResponse, json=request_to_dict(delete_users_request))
    
    def reactivate_users(self, reactivate_users_request: ReactivateUsersRequest = None) -> StreamResponse[ReactivateUsersResponse]:
        return self.post("/api/v2/users/reactivate", ReactivateUsersResponse, json=request_to_dict(reactivate_users_request))
    
    def restore_users(self, restore_users_request: RestoreUsersRequest=None) -> StreamResponse[Response]:
    ...
    def reactivate_user(self, user_id: str, reactivate_user_request: ReactivateUserRequest=None) -> StreamResponse[ReactivateUserResponse]:
        path_params = {
            "user_id": user_id, 
        }
