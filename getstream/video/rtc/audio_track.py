    ...
    async def recv(self) -> Frame:
        ...
        if data_to_play:
            ...
            if len(data_to_play) == bytes_per_frame * 2:
                ...
                if data_to_play[chunk1_size-1] == data_to_play[0] and data_to_play[chunk1_size] != data_to_play[0]:
            ...
            if len(data_to_play) > bytes_per_frame:
                ...
                if data_to_play[0] == data_to_play[1] and all(b == data_to_play[0] for b in data_to_play):
                    ...
                    frame = AudioFrame(format=self.format, layout=self.layout, samples=actual_samples)
                else:
