...
class AudioStreamTrackV2(aiortc.mediastreams.MediaStreamTrack):
    """
    Audio stream track that accepts PcmData objects directly from a queue.

    This is a simpler and more robust version of AudioStreamTrack that works
    with PcmData objects instead of raw bytes, avoiding format conversion issues.

    Usage:
        track = AudioStreamTrackV2(sample_rate=48000, channels=2)
    ...
    def __init__(
        ...
        """
        Initialize an AudioStreamTrackV2 that accepts PcmData objects.
        ...
        logger.debug(
            "Initialized AudioStreamTrackV2",
            extra={
