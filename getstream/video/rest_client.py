...
class VideoRestClient(BaseClient):
    ...
    def query_call_members(self, query_call_members_request: QueryCallMembersRequest) -> StreamResponse[QueryCallMembersResponse]:
    ...
    def block_user(self, type: str, id: str, block_user_request: BlockUserRequest) -> StreamResponse[BlockUserResponse]:
        path_params = {
            "type": type, "id": id, 
        }
    ...
    def send_call_event(self, type: str, id: str, send_event_request: SendEventRequest) -> StreamResponse[SendEventResponse]:
        path_params = {
            "type": type, "id": id, 
        }
    ...
    def collect_user_feedback(self, type: str, id: str, session: str, collect_user_feedback_request: CollectUserFeedbackRequest) -> StreamResponse[CollectUserFeedbackResponse]:
        path_params = {
    ...
    def video_pin(self, type: str, id: str, pin_request: PinRequest) -> StreamResponse[PinResponse]:
        path_params = {
            "type": type, "id": id, 
        }
    ...
    def unblock_user(self, type: str, id: str, unblock_user_request: UnblockUserRequest) -> StreamResponse[UnblockUserResponse]:
        path_params = {
            "type": type, "id": id, 
        }
    ...
    def video_unpin(self, type: str, id: str, unpin_request: UnpinRequest) -> StreamResponse[UnpinResponse]:
        path_params = {
            "type": type, "id": id, 
        }
    ...
    def update_user_permissions(self, type: str, id: str, update_user_permissions_request: UpdateUserPermissionsRequest) -> StreamResponse[UpdateUserPermissionsResponse]:
        path_params = {
            "type": type, "id": id, 
        }
    ...
    def create_call_type(self, create_call_type_request: CreateCallTypeRequest) -> StreamResponse[CreateCallTypeResponse]:
    ...
    def create_external_storage(self, create_external_storage_request: CreateExternalStorageRequest) -> StreamResponse[CreateExternalStorageResponse]:
    ...
    def update_external_storage(self, name: str, update_external_storage_request: UpdateExternalStorageRequest) -> StreamResponse[UpdateExternalStorageResponse]:
        path_params = {
            "name": name, 
        }
