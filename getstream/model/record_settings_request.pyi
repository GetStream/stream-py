...
class RecordSettingsRequest(schemas.DictSchema):
    ...
    def get_item_oapg(
        self, name: typing_extensions.Literal["audio_only"]
    ) -> typing.Union[MetaOapg.properties.audio_only, schemas.Unset]: ...
    @typing.overload
    def get_item_oapg(
        self, name: typing_extensions.Literal["mode"]
    ...
    def get_item_oapg(
        self, name: typing_extensions.Literal["quality"]
    ) -> typing.Union[MetaOapg.properties.quality, schemas.Unset]: ...
    @typing.overload
    def get_item_oapg(
        self, name: str
    ...
    def __new__(
        ...
        *_args: typing.Union[
        ...
        audio_only: typing.Union[
            MetaOapg.properties.audio_only, bool, schemas.Unset
        ] = schemas.unset,
        mode: typing.Union[
            MetaOapg.properties.mode, str, schemas.Unset
        ] = schemas.unset,
        quality: typing.Union[
            MetaOapg.properties.quality, str, schemas.Unset
        ] = schemas.unset,
