...
class JoinCallResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class edges(schemas.ListSchema):
                class MetaOapg:
                    @staticmethod
                ...
                def __new__(
                    cls,
                    _arg: typing.Union[
                        typing.Tuple["DatacenterResponse"],
                        typing.List["DatacenterResponse"],
                    ],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> "edges":
                    return super().__new__(
    ...
    @typing.overload
    def __getitem__(
        self, name: typing_extensions.Literal["edges"]
    ) -> MetaOapg.properties.edges: ...
    @typing.overload
    def __getitem__(
...
from getstream.model.call_response import CallResponse
from getstream.model.datacenter_response import DatacenterResponse
from getstream.model.member_response import MemberResponse
