...
class ChatRestClient(BaseClient):
    ...
    def create_block_list(self, create_block_list_request: CreateBlockListRequest=None) -> StreamResponse[Response]:
    ...
    def delete_channels(self, delete_channels_request: DeleteChannelsRequest=None) -> StreamResponse[DeleteChannelsResponse]:
    ...
    def send_event(self, type: str, id: str, send_event_request: SendEventRequest=None) -> StreamResponse[EventResponse]:
        path_params = {
            "type": type, "id": id, 
        }
    ...
    def send_message(self, type: str, id: str, send_message_request: SendMessageRequest=None) -> StreamResponse[SendMessageResponse]:
        path_params = {
            "type": type, "id": id, 
        }
    ...
    def get_many_messages(self, type: str, id: str, ids: Optional[List[str]]=None) -> StreamResponse[GetManyMessagesResponse]:
        query_params = {
    ...
    def create_channel_type(self, create_channel_type_request: CreateChannelTypeRequest=None) -> StreamResponse[CreateChannelTypeResponse]:
    ...
    def update_channel_type(self, name: str, update_channel_type_request: UpdateChannelTypeRequest=None) -> StreamResponse[UpdateChannelTypeResponse]:
        path_params = {
            "name": name, 
        }
    ...
    def create_command(self, create_command_request: CreateCommandRequest=None) -> StreamResponse[CreateCommandResponse]:
    ...
    def update_command(self, name: str, update_command_request: UpdateCommandRequest=None) -> StreamResponse[UpdateCommandResponse]:
        path_params = {
            "name": name, 
        }
    ...
    def export_channels(self, export_channels_request: ExportChannelsRequest=None) -> StreamResponse[ExportChannelsResponse]:
    ...
    def update_message(self, id: str, update_message_request: UpdateMessageRequest=None) -> StreamResponse[UpdateMessageResponse]:
        path_params = {
            "id": id, 
        }
    ...
    def run_message_action(self, id: str, message_action_request: MessageActionRequest=None) -> StreamResponse[MessageResponse]:
        path_params = {
            "id": id, 
        }
    ...
    def send_reaction(self, id: str, send_reaction_request: SendReactionRequest=None) -> StreamResponse[SendReactionResponse]:
        path_params = {
            "id": id, 
        }
    ...
    def translate_message(self, id: str, translate_message_request: TranslateMessageRequest=None) -> StreamResponse[MessageResponse]:
        path_params = {
            "id": id, 
        }
    ...
    def undelete_message(self, id: str, update_message_request: UpdateMessageRequest=None) -> StreamResponse[UpdateMessageResponse]:
        path_params = {
            "id": id, 
        }
    ...
    def cast_poll_vote(self, message_id: str, poll_id: str, cast_poll_vote_request: CastPollVoteRequest=None) -> StreamResponse[PollVoteResponse]:
        path_params = {
    ...
    def unban(self, target_user_id: Optional[str]=None, type: Optional[str]=None, id: Optional[str]=None, created_by: Optional[str]=None) -> StreamResponse[Response]:
        query_params = {
    ...
    def ban(self, ban_request: BanRequest=None) -> StreamResponse[Response]:
    ...
    def mute_user(self, mute_user_request: MuteUserRequest=None) -> StreamResponse[MuteUserResponse]:
    ...
    def unmute_user(self, unmute_user_request: UnmuteUserRequest=None) -> StreamResponse[UnmuteResponse]:
    ...
    def create_poll(self, create_poll_request: CreatePollRequest=None) -> StreamResponse[PollResponse]:
        return self.post("/api/v2/chat/polls", PollResponse, json=request_to_dict(create_poll_request))
    
    def update_poll(self, update_poll_request: UpdatePollRequest=None) -> StreamResponse[PollResponse]:
    ...
    def update_poll_partial(self, poll_id: str, update_poll_partial_request: UpdatePollPartialRequest=None) -> StreamResponse[PollResponse]:
        path_params = {
            "poll_id": poll_id, 
        }
    ...
    def create_poll_option(self, poll_id: str, create_poll_option_request: CreatePollOptionRequest=None) -> StreamResponse[PollOptionResponse]:
        path_params = {
            "poll_id": poll_id, 
        }
    ...
    def update_poll_option(self, poll_id: str, update_poll_option_request: UpdatePollOptionRequest=None) -> StreamResponse[PollOptionResponse]:
        path_params = {
            "poll_id": poll_id, 
        }
    ...
    def query_poll_votes(self, poll_id: str, user_id: Optional[str]=None, query_poll_votes_request: QueryPollVotesRequest=None) -> StreamResponse[PollVotesResponse]:
        query_params = {
            "user_id": encode_query_param(user_id), 
        }
        path_params = {
    ...
    def unread_counts_batch(self, unread_counts_batch_request: UnreadCountsBatchRequest=None) -> StreamResponse[UnreadCountsBatchResponse]:
        return self.post("/api/v2/chat/unread_batch", UnreadCountsBatchResponse, json=request_to_dict(unread_counts_batch_request))
    
    def send_user_custom_event(self, user_id: str, send_user_custom_event_request: SendUserCustomEventRequest=None) -> StreamResponse[Response]:
        path_params = {
            "user_id": user_id, 
        }
