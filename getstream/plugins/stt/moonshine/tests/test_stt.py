...
async def test_moonshine_model_validation():
    ...
    with patch("getstream.plugins.stt.moonshine.stt.moonshine"):
        ...
        with pytest.raises(ValueError, match="Unknown Moonshine model"):
            Moonshine(model_name="invalid_model")

        # Test valid model names
        stt1 = Moonshine(model_name="tiny")
        assert stt1.model_name == "moonshine/tiny"
        await stt1.close()

        stt2 = Moonshine(model_name="moonshine/base")
...
async def test_moonshine_model_selection():
    ...
    with patch("getstream.plugins.stt.moonshine.stt.moonshine"):
        # Test tiny model
        stt_tiny = Moonshine(model_name="moonshine/tiny")

        # Test base model
        stt_base = Moonshine(model_name="moonshine/base")
...
async def test_moonshine_with_mia_audio_mocked(mia_audio_data, mia_metadata):
    ...
    with patch("getstream.plugins.stt.moonshine.stt.moonshine") as mock_moonshine:
