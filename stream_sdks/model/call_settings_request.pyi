...
class CallSettingsRequest(schemas.DictSchema):
    ...
    def get_item_oapg(
        self, name: typing_extensions.Literal["audio"]
    ) -> typing.Union["AudioSettingsRequest", schemas.Unset]: ...
    @typing.overload
    def get_item_oapg(
        self, name: typing_extensions.Literal["backstage"]
    ) -> typing.Union["BackstageSettingsRequest", schemas.Unset]: ...
    @typing.overload
    def get_item_oapg(
        self, name: typing_extensions.Literal["geofencing"]
    ) -> typing.Union["GeofenceSettingsRequest", schemas.Unset]: ...
    @typing.overload
    def get_item_oapg(
        self, name: typing_extensions.Literal["recording"]
    ) -> typing.Union["RecordSettingsRequest", schemas.Unset]: ...
    @typing.overload
    def get_item_oapg(
        self, name: typing_extensions.Literal["ring"]
    ) -> typing.Union["RingSettingsRequest", schemas.Unset]: ...
    @typing.overload
    def get_item_oapg(
        self, name: typing_extensions.Literal["screensharing"]
    ) -> typing.Union["ScreensharingSettingsRequest", schemas.Unset]: ...
    @typing.overload
    def get_item_oapg(
        self, name: typing_extensions.Literal["transcription"]
    ) -> typing.Union["TranscriptionSettingsRequest", schemas.Unset]: ...
    @typing.overload
    def get_item_oapg(
        self, name: typing_extensions.Literal["video"]
    ) -> typing.Union["VideoSettingsRequest", schemas.Unset]: ...
    @typing.overload
    def get_item_oapg(
        self, name: str
    ...
    def __new__(
        ...
        *_args: typing.Union[
        ...
        backstage: typing.Union[
            "BackstageSettingsRequest", schemas.Unset
        ] = schemas.unset,
        geofencing: typing.Union[
            "GeofenceSettingsRequest", schemas.Unset
        ] = schemas.unset,
        ...
        screensharing: typing.Union[
            "ScreensharingSettingsRequest", schemas.Unset
        ] = schemas.unset,
        transcription: typing.Union[
            "TranscriptionSettingsRequest", schemas.Unset
        ] = schemas.unset,
...
from stream_sdks.model.audio_settings_request import AudioSettingsRequest
from stream_sdks.model.backstage_settings_request import BackstageSettingsRequest
from stream_sdks.model.geofence_settings_request import GeofenceSettingsRequest
from stream_sdks.model.record_settings_request import RecordSettingsRequest
from stream_sdks.model.ring_settings_request import RingSettingsRequest
from stream_sdks.model.screensharing_settings_request import (
    ScreensharingSettingsRequest,
)
from stream_sdks.model.transcription_settings_request import (
    TranscriptionSettingsRequest,
)
from stream_sdks.model.video_settings_request import VideoSettingsRequest
