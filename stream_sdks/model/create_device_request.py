...
class CreateDeviceRequest(
    ...
    class MetaOapg:
        class properties:
            ...
            @staticmethod
            def user() -> typing.Type["UserRequest"]:
                return UserRequest
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["user"]) -> "UserRequest":
        ...
    ...
    def __new__(
        ...
        *_args: typing.Union[
        ...
        user: typing.Union["UserRequest", schemas.Unset] = schemas.unset,
        user_id: typing.Union[
            MetaOapg.properties.user_id, str, schemas.Unset
        ] = schemas.unset,
...
from stream_sdks.model.user_request import UserRequest
