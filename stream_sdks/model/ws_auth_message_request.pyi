...
class WSAuthMessageRequest(
    ...
    @typing.overload
    def __getitem__(
        self, name: typing_extensions.Literal["user_details"]
    ) -> "ConnectUserDetailsRequest": ...
    @typing.overload
    def __getitem__(
        self, name: typing_extensions.Literal["device"]
    ) -> "DeviceFieldsRequest": ...
    @typing.overload
    ...
    def get_item_oapg(
        self, name: typing_extensions.Literal["device"]
    ) -> typing.Union["DeviceFieldsRequest", schemas.Unset]: ...
    @typing.overload
    def get_item_oapg(
        self, name: str
...
from stream_sdks.model.connect_user_details_request import ConnectUserDetailsRequest
from stream_sdks.model.device_fields_request import DeviceFieldsRequest
