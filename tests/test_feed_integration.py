...
class TestFeedIntegration:
    ...
    def setup_method(self):
        ...
        self.client = Stream(
            ...
            base_url=os.environ.get("STREAM_BASE_URL", "https://chat.stream-io-api.com"),
        )
        ...
        self.test_feed_2 = self.client.feeds.feed(self.USER_FEED_TYPE, self.test_user_id_2)
    ...
    def test_02_create_activity(self):
        ...
        # Compare text
        assert activity_response.activity.text == "This is a test activity from Python SDK"
    ...
    def test_04_get_single_activity(self):
        ...
        self._assert_response_success(create_response, "create activity for retrieval test")
    ...
    def test_05_update_activity(self):
        ...
        self._assert_response_success(create_response, "create activity for update test")
    ...
    def test_06_add_reaction(self):
        ...
        self._assert_response_success(create_response, "create activity for reaction test")
    ...
    def test_07_query_reactions(self):
        ...
        self._assert_response_success(create_response, "create activity for query reactions test")
    ...
    def test_08_add_comment(self):
        ...
        self._assert_response_success(create_response, "create activity for comment test")
    ...
    def test_09_query_comments(self):
        ...
        self._assert_response_success(create_response, "create activity for query comments test")
    ...
    def test_10_update_comment(self):
        ...
        self._assert_response_success(create_response, "create activity for update comment test")
        ...
        comment_id = comment_response_data.comment.id if comment_response_data.comment.id else f"comment-{uuid.uuid4()}"
        
        # snippet-start: UpdateComment
        response = self.client.feeds.update_comment(
            comment_id,
            comment="Updated comment text from Python SDK"
        )
    ...
    def test_11_add_bookmark(self):
        ...
        self._assert_response_success(create_response, "create activity for bookmark test")
    ...
    def test_12_query_bookmarks(self):
        ...
        response = self.client.feeds.query_bookmarks(
            limit=10,
            filter={"user_id": self.test_user_id}
        )
    ...
    def test_13_update_bookmark(self):
        ...
        self._assert_response_success(create_response, "create activity for update bookmark test")
    ...
    def test_17_pin_activity(self):
        ...
        response = self.test_feed.pin_activity(
            activity_id,
            user_id=self.test_user_id
        )
    ...
    def test_19_delete_bookmark(self):
        ...
        self._assert_response_success(create_response, "create activity for delete bookmark test")
        ...
        bookmark_data = bookmark_response.data
        folder_id = bookmark_data.bookmark.folder.id
        response = self.client.feeds.delete_bookmark(activity_id, folder_id, self.test_user_id)
    ...
    def test_20_delete_reaction(self):
        ...
        self._assert_response_success(create_response, "create activity for delete reaction test")
        ...
        response = self.client.feeds.delete_activity_reaction(activity_id, "like", self.test_user_id)
    ...
    def test_21_delete_comment(self):
        ...
        self._assert_response_success(create_response, "create activity for delete comment test")
        ...
        response = self.client.feeds.delete_comment(comment_id, hard_delete=False)  # soft delete
    ...
    def test_22_unfollow_user(self):
        ...
        try:
            ...
            self._assert_response_success(follow_response, "establish follow relationship for unfollow test")
    ...
    def test_23_delete_activities(self):
        ...
        for i in range(1, 3):
            ...
            self._assert_response_success(create_response, f"create activity {i} for delete test")
        ...
        for activity_id in activities_to_delete:
            ...
            response = self.client.feeds.delete_activity(activity_id, hard_delete=False)  # soft delete
    ...
    def test_28_query_activities_with_filters(self):
        ...
        for activity_type in activity_types:
            ...
            self._assert_response_success(create_response, f"create {activity_type} activity for filtering")
        ...
        try:
            ...
            response = self.client.feeds.query_activities(
                ...
                sort=[SortParamRequest(field="created_at", direction=-1)]  # newest first
            )
        ...
        try:
            ...
            self._assert_response_success(custom_filter_response, "query activities with custom filter")
        except Exception as e:
    ...
    def test_29_get_feed_activities_with_pagination(self):
        ...
        for i in range(1, 8):
            ...
            self._assert_response_success(create_response, f"create pagination activity {i}")
        ...
        self._assert_response_success(first_page_response, "get first page of feed activities")
        ...
        if next_token:
            ...
            self._assert_response_success(second_page_response, "get second page of feed activities")
        else:
    ...
    def test_31_authentication_scenarios(self):
        ...
        self._assert_response_success(update_response, "update activity with proper permissions")
    ...
    def test_32_real_world_usage_demo(self):
        ...
        for reaction_type in reaction_types:
            ...
            self._assert_response_success(reaction_response, f"add {reaction_type} reaction")
