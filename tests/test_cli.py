...
def test_create_token(mocker, cli_runner): # noqa
    ...
    result = cli_runner.invoke(
        stream_cli.cli, ["create-token", "--user-id", "your_user_id"]
    )
...
def test_add_option():
    ...
    cmd = add_option_from_arg(
        dummy_cmd,
        "string_param",
        inspect.Parameter(
            "string_param", inspect.Parameter.POSITIONAL_OR_KEYWORD, annotation=str
        ),
    )
    ...
    cmd = add_option_from_arg(
        ...
        "int_param",
        inspect.Parameter(
            "int_param", inspect.Parameter.POSITIONAL_OR_KEYWORD, annotation=int
        ),
    )
    ...
    cmd = add_option_from_arg(
        ...
        "bool_param",
        inspect.Parameter(
            "bool_param", inspect.Parameter.POSITIONAL_OR_KEYWORD, annotation=bool
        ),
    )
    ...
    cmd = add_option_from_arg(
        ...
        "list_param",
        inspect.Parameter(
            "list_param", inspect.Parameter.POSITIONAL_OR_KEYWORD, annotation=List[str]
        ),
    )
...
def test_video_call_get_or_create(mocker, cli_runner): # noqa
    ...
    mocker.patch(
        "json.dumps",
        return_value='{"cid": "default:123456", "members_limit": 10, "mocked": "json"}',
    )
    ...
    result = cli_runner.invoke(
        ...
        [
            ...
            "123456",
            "--data",
            '{"created_by_id": "user-id", "members_limit": 10}',
        ],
    )
...
def test_cli_create_call_with_members(mocker, cli_runner): # noqa
    ...
    result = cli_runner.invoke(
        ...
        [
            ...
            "123456",
            "--data",
            '{"created_by_id": "tommaso-id", "members": [{"user_id": "thierry-id"}, {"user_id": "tommaso-id"}]}',
        ],
    )
